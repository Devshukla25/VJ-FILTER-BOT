...
# Bot information
SESSION = environ.get('SESSION', 'shuklawoodbot')
...
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002190937021')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002190937021')
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None
INDEX_REQ_CHANNEL = int(environ.get('INDEX_REQ_CHANNEL', LOG_CHANNEL))
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002190937021')).split()]
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+UX923zyaL-k2Y2Vl')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/shuklawood')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/shuklawood')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'JAYxMAHAKAAL') # Support Chat Link Without https:// or @
...
SHORTLINK_URL = environ.get('SHORTLINK_URL', 'api.urlshortx.com')
SHORTLINK_API = environ.get('SHORTLINK_API', '3af8a68d5a33f463480e32b197878d720db4d740')
