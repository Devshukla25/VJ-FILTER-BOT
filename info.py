...
API_HASH = environ.get('API_HASH', '6884323130:AAEV4noIcltt1sriT9ABtx8KVDXOQE3DCxc')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002193230086')).split()]
